...
「獅尾加糖宋體」設計上針對筆畫粗細支援7種字重，所以不論大標、小標、簡單的段落排版都能清晰辨識：
...
### 「CJK TC」和「CJK SC」的比較：
![TC和SC比較](https://github.com/max32002/swei-sugar/raw/master/preview/compare_tc_sc.png)
...
### 「CJK TC」和「CJK JP」的比較：
![TC和SC比較](https://github.com/max32002/swei-sugar/raw/master/preview/compare_tc_jp.png)
...
## 更新日誌
[點擊此處](https://github.com/max32002/swei-sugar/blob/master/change_log.md) 查看更新記錄。
...
@font-face {
  ...
  src: url(https://cdn.jsdelivr.net/gh/max32002/swei-sugar@1.061/WebFont/CJK%20TC/SweiSugarCJKtc-Regular.woff2) format("woff2")
  , url(https://cdn.jsdelivr.net/gh/max32002/swei-sugar@1.061/WebFont/CJK%20TC/SweiSugarCJKtc-Regular.woff) format("woff");
}
```
